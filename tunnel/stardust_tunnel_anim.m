...
name = 'strdst_test.gif';

imwrite(imresize(N{1},TMSMAP,10,'nearest','Colormap','original'),TMSMAP,name,'gif','LoopCount',Inf,'DelayTime',0,'DisposalMethod','restorePrevious');
for n=2:Nf
    imwrite(imresize(N{n},TMSMAP,10,'nearest','Colormap','original'),TMSMAP,name,'gif','WriteMode','append','DelayTime',0,'DisposalMethod','restorePrevious');
end
...
for n=1:Nf
    ...
    system(['miz\MSX-O-Mizer.exe  -r basic\',name(1:5), '.bin miz\', name(1:5), '.miz ']);
